...
% Choose default command line output for TestSoundManager
handles.output = hObject;

handles.calfile = varargin{1,1};
...
% UIWAIT makes TestSoundManager wait for user response (see UIRESUME)
...
SoundCal = handles.SoundCal;
frequency = str2double(handles.frequency_edit.String);
